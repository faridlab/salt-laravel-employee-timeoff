...
namespace SaltEmployeeTimeoff\Providers;

use Illuminate\Support\ServiceProvider;

class EmployeeTimeoffServiceProvider extends ServiceProvider
{
    /**
    ...
    public function boot()
    {
         ...
         */
        $this->publishes([
            __DIR__.'/../../config/employee-timeoff.php' => config_path('employee-timeoff.php'),
        ], 'employee-timeoff-config');
         ...
         */
        // $this->loadTranslationsFrom(__DIR__.'/../../resources/lang', 'employee-timeoff');
        // $this->loadJsonTranslationsFrom(__DIR__.'/../../resources/lang', 'employee-timeoff');
        // $this->publishes([
        //     __DIR__.'/../../resources/lang' => resource_path('lang/vendor/employee-timeoff'),
        // ], 'translations');
         ...
         */
        // $this->loadViewsFrom(__DIR__.'/../../resources/views', 'employee-timeoff');
        // $this->publishes([
        //     __DIR__.'/../../resources/views' => resource_path('views/vendor/employee-timeoff'),
        // ], 'views');
        ...
        //     $this->commands([
        //         \SaltEmployeeTimeoff\Console\Commands\EmployeeTimeoffCommand::class,
        //     ]);
        // }
         ...
         */
        // $this->publishes([
        //     __DIR__.'/../../public' => public_path('vendor/employee-timeoff'),
        // ], 'public');
    ...
    public function register()
    {
        ...
        //     __DIR__.'/../../config/employee-timeoff.php', 'employee-timeoff'
        // );
    }
}
